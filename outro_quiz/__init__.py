...
def custom_export(players) -> Iterator[List[str | int | float]]:
    yield [
        "outro_quiz.session_code",
        "outro_quiz.player.participant_code",
        "outro_quiz.player.role",
        "outro_quiz.player.label",
        "outro_quiz.player.id_in_group",
        "outro_quiz.peq1",
        "outro_quiz.peq2",
        "outro_quiz.peq3",
        "outro_quiz.peq4",
        ...
        "outro_quiz.gender",
        "outro_quiz.age",
        "outro_quiz.grade_status",
        "outro_quiz.major",
        "outro_quiz.gpa",
        "outro_quiz.econ_classes",
        "outro_quiz.risk_comfort",
        "outro_quiz.strategy_notes",
    ]
